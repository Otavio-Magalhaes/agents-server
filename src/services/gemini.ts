...
export async function generateAnswer(
  ...
  const prompt = `
    Com base no texto forneceido abaixo como contexto responda a pergunta de forma clara e precisa em portugues do Brasil.
    ...
    - Se a responsta não for encontrada no contexto, apenas responda que não possui informações suficientes para responder;
    - Seja objetivo;
